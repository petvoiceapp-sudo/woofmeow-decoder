...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pawlingo — Traductor de perros y gatos" },
      { property: "og:description", content: "Descubre qué quiere decir tu mascota. Análisis científico con IA." },
